...
class ProductRepositorySearchTest {
	...
	void setUp() {
		...
		regionGangnam = regionRepository.save(Region.builder().province("서울특별시").city("강남구").lawCode("111").build());
		regionJongno = regionRepository.save(Region.builder().province("서울특별시").city("종로구").lawCode("222").build());
